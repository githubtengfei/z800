    ...
    class getsDetailpagedata {
        ...
        shoppingCart() {
            ...
            if (this.switchcolor == true && this.switchsize == true) {
                /* console.log(this.product_price.html());
                console.log(this.clickcolor)
                console.log(this.clicksize)
                console.log(this.small_pic_img.attr('src'))
                console.log(this.sid)
                console.log(this.datails_headline.html())
                console.log(this.number.find('input').val()) */
                // console.log($.cookie('sid'))
